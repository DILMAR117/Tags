...
class VistaCollar extends StatelessWidget{
  final img;

  VistaCollar(this.img);
    ...
    return Container(
      ...
      child: GridView (children: [
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
         children:[
         Image.asset('assets/collar2.jpeg', alignment:Alignment.center),
       ...
       InkWell(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
         children:[
         Image.asset('assets/collar3.jpeg', alignment:Alignment.center),
       ...
       InkWell(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
         children:[
         Image.asset('assets/collar4.jpeg', alignment:Alignment.center,),
         Padding(padding: EdgeInsets.fromLTRB(10.0, 20.0, 0.0, 0.0)),
         Icon(Icons.shopping_cart,size: 20, color: Colors.white,),
         Text("Precio: 200", style: TextStyle(fontSize: 15,color: Colors.white, fontWeight: FontWeight.bold),)
       ],
